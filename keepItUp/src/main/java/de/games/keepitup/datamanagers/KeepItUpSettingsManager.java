...
import android.games.datamanagers.ISettingsManager;
...
public class KeepItUpSettingsManager implements ISettingsManager {
	...
	private static KeepItUpSettingsManager instance;

	private KeepItUpSettingsManager(final Activity activity) {
		this.activity = activity;
	}

	public static void init(final Activity activity) {
		instance = new KeepItUpSettingsManager(activity);
		instance.loadAllFromPreferences();
	}

	public static synchronized KeepItUpSettingsManager getInstance() {
		if (instance == null) {
