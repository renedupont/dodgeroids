package android.games.dodgeroids.logic;
...
import android.games.dodgeroids.datamanagers.DodgeroidsSettingsManager;
...
public class GameLoopLogic extends AbstractGameLogic {
	...
	public GameLoopLogic(final AbstractGameActivity activity,
		...
		this.flipVal = DodgeroidsSettingsManager.getInstance().isControlFlipped() ? -1
				: 1;
