...
public class Texture {
	 ...
	 * @param bitmap
	 */
	public Texture(final GL11 gl, final Bitmap image,
			final TextureFilter minFilter, final TextureFilter maxFilter,
			final TextureWrap sWrap, final TextureWrap tWrap) {
		this.gl = gl;
	...
	public Texture(final GL11 gl, final int width, final int height,
			final TextureFilter minFilter, final TextureFilter maxFilter,
			final TextureWrap sWrap, final TextureWrap tWrap) {
