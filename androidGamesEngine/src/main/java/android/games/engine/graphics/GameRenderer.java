...
import android.games.engine.graphics.Camera.Projection;
...
public class GameRenderer {
	...
	public void render(final GL11 gl, final int width, final int height) {
		...
		camera.setMode(gl, Projection.PERSPECTIVE);
		camera.render(gl);
		...
		camera.setMode(gl, Projection.ORTHOGRAPHIC);
