...
public class Light {//
	public enum Id {
		ZERO(GL11.GL_LIGHT0), ONE(GL11.GL_LIGHT1), TWO(GL11.GL_LIGHT2), THREE(
				GL11.GL_LIGHT3), FOUR(GL11.GL_LIGHT4), FIVE(GL11.GL_LIGHT5), SIX(
				GL11.GL_LIGHT6), SEVEN(GL11.GL_LIGHT7);
	...
	/**
	 * cutoff = winkel des lichtkegels * 2, also maximal 180 sonst hat man ein
	 * pointlight
	 **/
	...
	public void setCutoff(final float cutoff) {
		if (cutoff > 180 || cutoff < 0) {
			throw new IllegalArgumentException(
					"cutoff has to be between 0 and 180");
		}
		this.cutoff = cutoff;
	}
