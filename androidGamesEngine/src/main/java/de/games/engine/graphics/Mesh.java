...
public final class Mesh {
    ...
    public Mesh(
            ...
            final boolean hasTextureCoordinates,
    ...
    private void update() {
        if (!globalVBO) {
            ...
            gl.glBufferData(
                    GL11.GL_ARRAY_BUFFER, vertices.length * 4, vertexBuffer, GL11.GL_DYNAMIC_DRAW);

            if (colors != null) {
                gl.glBindBuffer(GL11.GL_ARRAY_BUFFER, colorHandle);
                gl.glBufferData(
                        GL11.GL_ARRAY_BUFFER, colors.length * 4, colorBuffer, GL11.GL_DYNAMIC_DRAW);
            }
    ...
    /**
     * Renders the mesh as the given type, starting at offset using numVertices vertices.
     *
     * @param type the type
     * @param offset the offset, in number of vertices
     * @param numVertices the number of vertices to use
     */
    public void render(final RenderType type, final int offset, final int numVertices) {
    ...
    /**
     * Renders the mesh as the given type using as many vertices as have been defined by calling
     * vertex().
     *
     * @param type the type
     */
    ...
    /**
     * Defines the position of the current vertex. Before you call this you have to call any other
     * method like color, normal and texCoord for the current vertex!
     *
