...
public class Color {
    ...
    /**
     * Linearly interpolates between this color and the target color by t which is in the range
     * [0,1]. The result is stored in this color.
     *
     ...
     * @return the packed color as a 32-bit int
     */
    public static int toIntBitsABGR(final int r, final int g, final int b, final int a) {
