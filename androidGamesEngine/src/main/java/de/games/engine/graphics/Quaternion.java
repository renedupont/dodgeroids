...
public class Quaternion {
    ...
    public Quaternion mul(final Quaternion other) {
        float scalarbit = this.w * other.w - this.x * other.x - this.y * other.y - this.z * other.z;
        float newx = this.y * other.z - this.z * other.y + this.w * other.x + other.w * this.x;
        float newy = -this.x * other.z + other.x * this.z + this.w * other.y + other.w * this.y;
        float newz = this.x * other.y - other.x * this.y + this.w * other.z + other.w * this.z;
