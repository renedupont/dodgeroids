...
public class BlockArray {
    ...
    private int
            newObstacleIndex; // determines when a new obstacle needs to be added to the block array
    private int
            currentObstacleIndex; // the current index which gets incremented with each new block
    // array
